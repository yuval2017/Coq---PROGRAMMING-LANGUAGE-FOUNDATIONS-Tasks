...
(** **** Exercise: 1 star, standard, optional (snd_fst_is_swap)  *)
...
(* Do not modify the following line: *)
Definition manual_grade_for_bag_count_sum : option (nat*string) := None.
(** [] *)
...
(** **** Exercise: 2 stars, standard, optional (hd_error) 
...
(** **** Exercise: 1 star, standard, optional (eqb_id_refl)  *)
...
(** **** Exercise: 1 star, standard, optional (update_eq)  *)
Theorem update_eq :
...
(** **** Exercise: 1 star, standard, optional (update_neq)  *)
Theorem update_neq :
